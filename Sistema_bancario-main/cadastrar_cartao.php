        ...
        <div class="container">
            ...
            <div class="divCadastro">
                ...
                <div class="form-group">
                        ...
                        <input type="text" name="nome" id="nome" placeholder="Digite o número do cartão" required>
                    </div>    
                <div class="form-group">
                    ...
                    <?php 
                        ...
                        echo '<input type="hidden" name="idCliente" id="idCliente" value="' . $idCliente_cartao .'">'
					?>
